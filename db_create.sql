create table AppActivity (businessIdentifier varchar(255), plannedEnd datetime, plannedStart datetime, realEnd datetime, realStart datetime, id bigint not null, status_id bigint, primary key (id));
...
create table AppActivityRelation (id bigint not null, firstActivity_id bigint, relationType_id bigint, secondActivity_id bigint, primary key (id));
...
create table AppActivityStatusTransition (id bigint not null, allowedGroup_id bigint, fromStatus_id bigint, toStatus_id bigint, primary key (id));
...
create table AppObject (id bigint not null, creationDate datetime, displayName varchar(255), modificationDate datetime, version bigint, authorizedForDeletion_id bigint, authorizedForModification_id bigint, authorizedForView_id bigint, creator_id bigint, lastEditor_id bigint, primary key (id));
...
create table AppProperty (propertyKey varchar(255), value tinyblob, id bigint not null, parentObject_id bigint, sourceTemplate_id bigint, primary key (id));
...
insert into hibernate_sequence values ( 1 );
alter table AppActivity add constraint FK97ei9r63br7y4w2vl4a3inphc foreign key (status_id) references AppActivityStatus (id);
...
alter table AppActivityRelation add constraint FKlqetqoh6xiynw8c7rfkld22jj foreign key (relationType_id) references AppActivityRelationType (id);
...
alter table AppActivityStatusTransition add constraint FK2rstl5tejwaxn48c1dhw0wwdq foreign key (allowedGroup_id) references AppUserGroup (id);
...
alter table AppObject add constraint FKt79sblng0tijcq978hsrlexp2 foreign key (authorizedForDeletion_id) references AppUserGroup (id);
alter table AppObject add constraint FK7spnhao36gyou6q72u0vu5p2m foreign key (authorizedForModification_id) references AppUserGroup (id);
alter table AppObject add constraint FKmfwkwrjp0ov3hrm4koayh4fdu foreign key (authorizedForView_id) references AppUserGroup (id);
alter table AppObject add constraint FK2247b6ylyhawr1x6khklxlqvy foreign key (creator_id) references AppUser (id);
alter table AppObject add constraint FK6fufyl6dqurtac9drsm2cr9d8 foreign key (lastEditor_id) references AppUser (id);
alter table AppPerson add constraint FK49kimb6fvs91nnfh6c9q8b4kw foreign key (id) references AppObject (id);
alter table AppProperty add constraint FKlr93p5ukp3rqy4g98b3k919sn foreign key (parentObject_id) references AppObject (id);
alter table AppProperty add constraint FKgtl77wq25ju22md0ykkna2tgu foreign key (sourceTemplate_id) references AppPropertyTemplate (id);
...
create table AppIntegerProperty (id bigint not null, primary key (id));
create table AppNumberProperty (id bigint not null, primary key (id));
create table AppObject (id bigint not null auto_increment, creationDate datetime, displayName varchar(255), modificationDate datetime, version bigint, authorizedForDeletion_id bigint, authorizedForModification_id bigint, authorizedForView_id bigint, creator_id bigint, lastEditor_id bigint, primary key (id));
create table AppPerson (canonicalName varchar(255), email varchar(255), firstName varchar(255), fullName varchar(255), lastName varchar(255), id bigint not null, primary key (id));
create table AppProperty (propertyKey varchar(255), value tinyblob, id bigint not null, parentObject_id bigint, sourceTemplate_id bigint, primary key (id));
create table AppPropertyTemplate (id bigint not null, primary key (id));
create table AppPropertyType (label varchar(255), id bigint not null, primary key (id));
...
create table AppIntegerProperty (id bigint not null, primary key (id));
create table AppNumberProperty (id bigint not null, primary key (id));
create table AppObject (id bigint not null, creationDate datetime, displayName varchar(255), isTemplateObject bit, modificationDate datetime, sourceTemplate tinyblob, version bigint, authorizedForDeletion_id bigint, authorizedForModification_id bigint, authorizedForView_id bigint, creator_id bigint, lastEditor_id bigint, primary key (id));
create table AppPerson (canonicalName varchar(255), email varchar(255), firstName varchar(255), fullName varchar(255), lastName varchar(255), id bigint not null, primary key (id));
create table AppProperty (propertyKey varchar(255), value tinyblob, id bigint not null, parentObject_id bigint, primary key (id));
create table AppPropertyType (label varchar(255), id bigint not null, primary key (id));
create table AppStringProperty (id bigint not null, primary key (id));
create table AppTranslation (id bigint not null, sourceContext varchar(255), sourceCssSelector varchar(255), sourceIdentifierCode varchar(255), sourceText varchar(255), translatedContext varchar(255), translatedCssSelector varchar(255), translatedIdentifierCode varchar(255), translatedText varchar(255), primary key (id));
create table AppUser (disabled bit not null, lastLogin datetime, lastLoginFailure datetime, secret1 varchar(255), secret2 varchar(255), secret3 varchar(255), securityIndex integer not null, username varchar(255), id bigint not null, primary key (id));
...
create table AppIntegerProperty (id bigint not null, primary key (id));
create table AppNumberProperty (id bigint not null, primary key (id));
create table AppObject (id bigint not null, creationDate datetime, displayName varchar(255), isTemplateObject bit, modificationDate datetime, naturalId varchar(255), sourceTemplate tinyblob, version bigint, authorizedForDeletion_id bigint, authorizedForModification_id bigint, authorizedForView_id bigint, creator_id bigint, lastEditor_id bigint, primary key (id));
create table AppPerson (canonicalName varchar(255), email varchar(255), firstName varchar(255), fullName varchar(255), lastName varchar(255), id bigint not null, primary key (id));
create table AppProperty (propertyKey varchar(255), value tinyblob, id bigint not null, parentObject_id bigint, primary key (id));
create table AppPropertyType (label varchar(255), id bigint not null, primary key (id));
create table AppStringProperty (id bigint not null, primary key (id));
...
insert into hibernate_sequence values ( 1 );
insert into hibernate_sequence values ( 1 );
alter table AppObject add constraint UK_c7grixlon2i3plnxg56usdj2u unique (naturalId);
alter table AppActivity add constraint FK97ei9r63br7y4w2vl4a3inphc foreign key (status_id) references AppActivityStatus (id);
alter table AppActivity add constraint FKaplwph3gaa9tlcowfeqbqpsxj foreign key (id) references AppObject (id);
alter table AppActivityGraph add constraint FKcj6mqaq2mr4qv3ym7dqqwl76w foreign key (id) references AppObject (id);
alter table AppActivityGroup add constraint FK361afohyjvymmn66sn5uxelto foreign key (id) references AppObject (id);
